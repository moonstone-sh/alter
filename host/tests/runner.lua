package.path = "src/?.lua;src/?/init.lua;?.lua;?/init.lua;tests/?.lua;" .. package.path
...
local specs = {
    "host.document_spec",
    "host.navigation_spec",
    "host.conflict_spec",
    "contracts.schemas_spec",
    "contracts.luacats_sync_spec",
    "isolation.runtime_dep_spec",
}

print("=== Running Alter Host Test Suites ===")
...
if failed > 0 then
    ...
    print("All tests in Alter Host Test Suites passed successfully!\n")
end
